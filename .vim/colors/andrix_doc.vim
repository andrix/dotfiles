...
hi Folded 		ctermbg=black	    ctermfg=255	         guifg=#000000  guibg=#efefef	gui=italic
hi Identifier 	ctermfg=105	        ctermbg=white	     guifg=#7799bb	guibg=#ffffff	gui=none
hi ModeMsg		ctermfg=white	    ctermbg=39	         guifg=#ffffff	guibg=#6694e3	gui=bold
hi NonText 		ctermfg=255	        ctermbg=white        guifg=#f0f0f0	guibg=#ffffff	gui=none
hi Normal    	ctermfg=black	    ctermbg=white	     guifg=#000000	guibg=#ffffff	gui=none
...
hi Statement 	ctermfg=25	        ctermbg=white        guifg=#2a5db0	guibg=#ffffff	gui=bold,underline
hi StatusLine 	ctermfg=white	    ctermbg=39           guifg=#ffffff	guibg=#6694e3	gui=bold
hi StatusLineNC ctermfg=246	        ctermbg=220          guifg=#aaaaaa	guibg=#e0ecff	gui=none
hi Todo 		ctermfg=white	    ctermbg=132          guifg=#ffffff	guibg=#d96666	gui=bold
hi Type 		ctermfg=36	        ctermbg=white        guifg=#006633	guibg=#ffffff	gui=bold
hi Underlined	ctermfg=black	    ctermbg=white        guifg=#000000	guibg=#ffffff	gui=underline
